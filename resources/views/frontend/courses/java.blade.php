...
{{-- <section id="cta" class="cta">
    <div class="container" data-aos="zoom-in">
      ...
      <div class="text-center">
        <a class="cta-btn scrollto" href="#appointment">LEARN JAVAs </a>
      </div>
...
<div class="text-center">
      ...
      @Auth
      <a href="/paywithrazorpay/java course" class="btn btn-success">Pay Now</a>
      @else
          ...
          <div class="modal-body">
            <form action="/talk_to_us" method="POST">
              ...
              <div class="form-group">
                  ...
                  <input type="hidden" class="form-control mb-2" name="req" value="java course"/>
