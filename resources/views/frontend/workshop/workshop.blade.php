      ...
      {{-- <div class="our_solution_category"> --}}
        <div class="solution_cards_box">
          <div class="solution_card">
            ...
            <div class="solu_title">
              <h3>WORK SHOP IN YOUR INSTITUTION</h3>
            </div>
            <div class="solu_description">
              <p>
                For conducting workshop in institutions
              </p>
              <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#institution" class="btn-buy">click here</button>
        ...
        <div class="solution_cards_box">
          ...
          <div class="solution_card">
            ...
            <div class="solu_title">
              <h3>WORK SHOP IN OUR XPERT MINDZ</h3>
            </div>
            <div class="solu_description">
              <p>
                For conducting workshop in xpert mindz
              </p>
              <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#xpertmindz" class="btn-buy">click here</button>
...
<div class="modal fade" id="xpertmindz" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Fill your details</h5>
