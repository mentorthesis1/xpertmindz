...
Route::get('/login_view',[AuthController::class,'login_view'])->middleware('guest')->name('login');
Route::get('/register_view',[AuthController::class,'register_view'])->middleware('guest');
...
Route::get('/student_register',[AuthController::class,'student_register'])->middleware('guest');


Route::get('/institution_register',[AuthController::class,'institution_register'])->middleware('guest');
